...
class Session {
    ...
    Session(const aria2::KeyVals& options = {},
        ...
        aria2::libraryInit();
//        sessionConfig = new aria2::SessionConfig();
//        sessionConfig = &session_config;
//        (*sessionConfig).keepRunning = true;
//        (*sessionConfig).userData = this;
//        (*sessionConfig).downloadEventCallback = download_event_wrapper;
...
//    inline static aria2::SessionConfig *sessionConfig = nullptr;
    /**
...
//        int a = aria2::run(session, mode);
//        std::cerr << "This is run value: " << a << std::endl;
